...
def get_imputationmean_actualmean_actualstd_of_locantdistance_feature():
    ...
    with open('/home/chaurasi/semesterproject/trial_2_3/misato-dataset/src/data/processing/Maps/atoms_name_map_for_pdb.pickle', mode='rb') as f:
        name_mapping = pickle.load(f)

    with open('/home/chaurasi/semesterproject/trial_2_3/misato-dataset/src/data/processing/Maps/atoms_type_map.pickle', mode='rb') as f:
