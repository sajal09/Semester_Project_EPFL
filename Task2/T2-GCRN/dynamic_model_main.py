...
from models import DynamicModelGRUBatched
...
model = DynamicModelGRUBatched(node_feat_dim=node_feat_dim,
...
checkpoint_folder = '/work/lts2/users/sajal/temp34/wandb/CheckpointDynamicModel'
