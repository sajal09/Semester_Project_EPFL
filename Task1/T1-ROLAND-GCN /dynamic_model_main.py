...
from models import RolandDynamicModelGRU
...
#77953, 24097, 52993 #73857, 24097, 48897
gnn_out=32
gru_hidden=64
num_gru_layers = 2
gru_dropout = 0.0
...
model = RolandDynamicModelGRU(node_feat_dim=node_dim,
                             gnn_out=gnn_out,
...
resume = True
checkpoint_folder = '/home/chaurasi/semesterproject/temp7/wandb/CheckpointDynamicModel'

if resume:
    wandb.init(project="semester_project_epfl", id="uvktuyl0", resume='must')
