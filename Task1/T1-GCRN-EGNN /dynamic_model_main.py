...
from models import DynamicModelGRU_EGNN
...
T = 100
folder_path = '/scratch/chaurasi/data/full_data/'#'/work/lts2/users/sajal/data/full_data/'
...
model = DynamicModelGRU_EGNN(node_feat_dim=node_dim,
                             gnn_hidden=gnn_hidden, 
                             gnn_hidden2=gnn_hidden2,
                             gnn_out=gnn_out,
...
resume = True
checkpoint_folder = '/home/chaurasi/semesterproject/temp8/wandb/CheckpointDynamicModel'

if resume:
    wandb.init(project="semester_project_epfl", id="bq0evxec", resume='must')
