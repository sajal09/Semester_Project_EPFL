...
model = DynamicModelGRU(node_feat_dim=node_dim,
...
resume = True
checkpoint_folder = '/home/chaurasi/semesterproject/temp6/wandb/CheckpointDynamicModel'

if resume:
    wandb.init(project="semester_project_epfl", id="jhph6s5n", resume='must')
